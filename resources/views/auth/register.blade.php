                        ...
                        <div class="form-col">
                            <div class="form-left">
                                <div class=" form-group">
                                    ...
                                    <input name="name0" type="text" class="form-control" id="validationDefault05" placeholder="Full Name" required>
                                </div>
                                <div class=" form-group">
                                    <!-- Leader Email -->
                                    <label for="validationDefault06 inputEmail2">Email</label>
                                    <input name="email0" type="email" class="form-control" id="validationDefault07 InputEmail2" placeholder="Email" required>
                                </div>
                                <div class=" form-group">
                                    <!-- Leader Address -->
